...
class MultanHotel1 extends StatelessWidget {
  final Hotel hotel;
  TextEditingController nameController = TextEditingController();

  MultanHotel1({required this.hotel});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/mult1.jpg', // Replace with actual image asset path
              height: 200,
              fit: BoxFit.cover,
            ),
            SizedBox(height: 10,),
            Image.asset(
              'assets/images/mult2.jpg', // Replace with actual image asset path
              height: 200,
              fit: BoxFit.cover,
            ),
            // Location
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded( // Use Expanded to allow the text to take all available space
                        child: Text(
                          '789 Multan Street, Multan, Pakistan', // Use actual hotel location
                          style: TextStyle(
                            fontSize: 18.0,
                            fontWeight: FontWeight.bold,
                          ),
