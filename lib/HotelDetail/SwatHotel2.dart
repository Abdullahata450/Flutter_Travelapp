...
class SwatHotel2 extends StatelessWidget {
  final Hotel hotel;
  TextEditingController nameController = TextEditingController();

  SwatHotel2({required this.hotel});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/swh3.jpg', // Replace with actual image asset path
              height: 200,
              fit: BoxFit.cover,
            ),
            SizedBox(height: 10,),
            Image.asset(
              'assets/images/swh4.jpg', // Replace with actual image asset path
              height: 200,
              fit: BoxFit.cover,
            ),
            // Location
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Expanded( // Use Expanded to allow the text to take all available space
                        child: Text(
                          '202 Swat Boulevard, Swat, Pakistan', // Use actual hotel location
                          style: TextStyle(
                            fontSize: 18.0,
                            fontWeight: FontWeight.bold,
                          ),
                  ...
                  Text(
                    'Standard Room \n Free Wi-Fi \n In-room Dining', // Use actual nearby attractions
                    style: TextStyle(
                        fontSize: 17,
