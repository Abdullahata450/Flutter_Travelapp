...
class IslamabadHotel2 extends StatefulWidget {
  final Hotel hotel;

  IslamabadHotel2({required this.hotel});

  @override
  _IslamabadHotel2State createState() => _IslamabadHotel2State();
}

class _IslamabadHotel2State extends State<IslamabadHotel2> {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded( // Use Expanded to allow the text to take all available space
                        child: Text(
                          '456 Islamabad Street, Islamabad, Pakistan', // Use actual hotel location
                          style: TextStyle(
                            fontSize: 18.0,
                            fontWeight: FontWeight.bold,
                          ),
