...
class SwatHotel1 extends StatelessWidget {
  final Hotel hotel;
  TextEditingController nameController = TextEditingController();

  SwatHotel1({required this.hotel});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/swh1.jpg', // Replace with actual image asset path
              height: 200,
              fit: BoxFit.cover,
            ),
            SizedBox(height: 10,),
            Image.asset(
              'assets/images/swh2.jpg', // Replace with actual image asset path
              height: 200,
              fit: BoxFit.cover,
            ),
            // Location
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Expanded( // Use Expanded to allow the text to take all available space
                        child: Text(
                          '101 Swat Street, Swat, Pakistan', // Use actual hotel location
                          style: TextStyle(
                            fontSize: 18.0,
                            fontWeight: FontWeight.bold,
                          ),
                  ...
                  Text(
                    'Deluxe Room \n Mountain View \n Free Breakfast', // Use actual nearby attractions
                    style: TextStyle(
                        fontSize: 17,
